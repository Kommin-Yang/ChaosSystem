...
#include "ChaosSystemSportsCar.h"
#include "ChaosSystemSportsWheelFront.h"
#include "ChaosSystemSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AChaosSystemSportsCar::AChaosSystemSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UChaosSystemSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UChaosSystemSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UChaosSystemSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UChaosSystemSportsWheelRear::StaticClass();
