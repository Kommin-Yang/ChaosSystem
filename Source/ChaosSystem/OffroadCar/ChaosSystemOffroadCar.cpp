...
#include "ChaosSystemOffroadCar.h"
#include "ChaosSystemOffroadWheelFront.h"
#include "ChaosSystemOffroadWheelRear.h"
...
AChaosSystemOffroadCar::AChaosSystemOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UChaosSystemOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UChaosSystemOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UChaosSystemOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UChaosSystemOffroadWheelRear::StaticClass();
